...
def evaluate(frame_num, layer_nums, input_channels, output_channels, model_path, evaluate_name, bn=False):
    ...
    :return:
    '''
    generator = UNet(input_channels=input_channels, layer_nums=layer_nums, output_channel=output_channels,
                     bn=bn).cuda().eval()
...
if __name__ == '__main__':
    evaluate(frame_num=5, layer_nums=4, input_channels=12, output_channels=3,
